    ...
    <div className="container mx-auto px-4">
      <div className="navbar">
        ...
        <div className="navbar-end">
          ...
          <label className="swap swap-rotate btn btn-primary btn-circle mx-2">
            ...
            {/* sun icon */}
            <svg
              className="swap-off h-6 w-6 text-base-100 ms-[1px] fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
            ...
            <svg
              className="swap-on h-6 w-6 ms-0.5 fill-current rounded-full text-base-100"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
